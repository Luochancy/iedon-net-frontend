...
peering: {
      ...
      directInfo1: '暗号化なしダイレクトイーサネットピアリング',
      directInfo2: '両側でインターフェースを事前設定が必要',
      directInfo3: 'リモートピアのIPが必要',
      directSessionLimit: '同じエンドポイントでノードごとにセッションは1つだけ作成できます',
      directLanInfo: 'ピアIPアドレスは以下のサブネット内にある必要があります',
      directTitle: 'ダイレクトイーサネット',
      directLocalInterface: 'ローカルインターフェース',
      thankYou: 'ありがとうございます',
