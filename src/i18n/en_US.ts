...
export default {
  ...
  pages: {
    ...
    signIn: {
      ...
      sshChallengePayload: 'Challenge payload',
      sshExampleCommand: 'Example command:',
      sshSignHint: 'Paste the contents of the generated SSH signature file into the input below',
...
peering: {
      ...
      directInfo1: 'Unencrypted direct Ethernet peering',
      directInfo2: 'Interfaces must be pre-configured on both sides',
      directInfo3: 'Remote peer IP is required',
      directSessionLimit: 'You can create only 1 session with the same endpoint per node',
      directLanInfo: 'Your peer IP addresses must be within the following subnets',
      directTitle: 'Direct Ethernet',
      directLocalInterface: 'Local Interface',
      thankYou: 'Thank you',
    ...
    chartError: {
      ...
      nodes: {
        ...
        resetSecretHint: 'Leave empty to keep current secret',
        secretSet: 'Set',
        secretNotSet: 'Not Set',
        subtitle: 'Manage nodes, agents, and peering configuration',
        view: 'View',
        // Detail page
        ...
        publicLabel: 'Public',
        openPeeringLabel: 'Open Peering',
        autoPeeringLabel: 'Auto Peering',
        peeringCapabilities: 'Peering Capabilities',
        sessionCapacityLabel: 'Session Capacity',
        callbackUrlLabel: 'Callback URL',
        linkTypesLabel: 'Link Types',
        bgpExtensions: 'BGP Extensions',
        allowedPoliciesLabel: 'Allowed Policies',
        ...
        kernel: 'Kernel',
        agentNotReporting: 'Agent not reporting — no metric data available',
        forceSync: 'Force Sync',
        diagnostics: 'Diagnostics',
        diagnosticsComingSoon: 'LG tools, callback test, and probe diagnostics coming soon',
        dangerZone: 'Danger Zone',
        deleteNode: 'Delete Node',
        deleteNodeConfirm: 'Delete Node?',
        deleteNodeDesc: 'This will permanently delete',
        deleteNodeWarning: 'and cannot be undone.',
      }
    },
    metrics: {
